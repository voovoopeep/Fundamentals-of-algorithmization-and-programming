...
MyStdString::MyStdString()
    : data_(std::make_unique<char[]>(size_update))
...
MyStdString::MyStdString(const char *str)
    : data_(nullptr)
    , reserved_(0)
    , size_(0)
{
...
MyStdString::MyStdString(const MyStdString &other)
    : size_(other.size_)
{
...
MyStdString::MyStdString(size_t reserve)
    : data_(std::make_unique<char[]>(reserve + 1))
    , reserved_(reserve + 1)
    , size_(0)
{
    data_[0] = '\0';
