...
void MainWindow::on_bnt_memcpy_clicked()
{
    ...
    QMessageBox::information(
        nullptr,
        "Результат                                                                          ",
        QString("С помощью метода memcpy n символов было скопировано из String1 в QLineEdit"));
}
...
void MainWindow::on_bnt_memmove_clicked()
{
    ...
    QMessageBox::information(
        nullptr,
        "Результат                                                                          ",
        QString("С помощью метода memmove данные были перемещены из String1 в QLineEdit"));
}
...
void MainWindow::on_bnt_strcpy_clicked()
{
    ...
    QMessageBox::information(
        nullptr,
        "Результат                                                                          ",
        QString("С помощью метода strcpy данные были перемещены из String1 в QLineEdit"));
}
