    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->countGenerate->setVisible(false);
    ui->insertButton_2->setVisible(false);
}
...
void MainWindow::on_getButton_clicked()
{
    ...
    if (ui->getValue->text() == "error!@#$%^&*()")
        ui->getValue->setText("Not founded");
}
