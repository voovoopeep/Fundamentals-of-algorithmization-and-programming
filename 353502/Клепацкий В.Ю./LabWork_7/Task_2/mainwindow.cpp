    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->comboBox->addItems(
        {"Прямой обход", "Обратный обход", "Симметричный обход (по возрастанию ключей)"});
...
void MainWindow::on_removeButton_clicked()
{
    ...
    if (foundedNode == nullptr)
        ui->lineEdit->setText("Элемента с ключом " + QString::number(ui->keyInsert->value())
                              + " не найден.");
    else
        ui->lineEdit->setText("");
    //ui->lineEdit->setText("Элемент с ключом " + QString::number(ui->keyInsert->value()) + " удален с балансировкой.");
...
void MainWindow::on_searchButton_clicked()
{
    ...
    if (foundedNode != nullptr)
        ui->lineEdit->setText("Значение найденного по ключу элемента : '" + foundedNode->value
                              + "'.");
    else
        ui->lineEdit->setText("Элемента с ключом " + QString::number(ui->keyInsert->value())
                              + " не найден.");
