...
template<typename T>
typename myVector<T>::b_iterator myVector<T>::begin() {
    return b_iterator(arr_);
}

template<typename T>
typename myVector<T>::b_iterator myVector<T>::end() {
    return b_iterator(arr_ + size_);
}

template<typename T>
typename myVector<T>::c_iterator myVector<T>::cbegin() const {
    return c_iterator(arr_);
}

template<typename T>
typename myVector<T>::c_iterator myVector<T>::cend() const {
    return c_iterator(arr_ + size_);
}

template<typename T>
typename myVector<T>::r_iterator myVector<T>::rbegin() {
    return r_iterator(arr_ + size_);
}

template<typename T>
typename myVector<T>::r_iterator myVector<T>::rend() {
