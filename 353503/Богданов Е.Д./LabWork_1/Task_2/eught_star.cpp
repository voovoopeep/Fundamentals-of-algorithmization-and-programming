...
Eught_star::Eught_star(QPointF point_first)
...
void Eught_star::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    const int kolvo_yglov = 8;
    const int kolvo_treug = 16;

    const int last_point = 7;
