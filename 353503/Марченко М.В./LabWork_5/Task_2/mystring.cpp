...
int MyString::memcmp(const void *ptr1, const void *ptr2, size_t n)
{
...
int MyString::strncmp(const char *str1, const char *str2, size_t n)
{
...
size_t MyString::strxfrm(char *dest, const char *src, size_t n)
{
    size_t srcLen = MyString::strlen(src);
...
void *MyString::memset(void *dest, int value, size_t n)
{
...
const char *MyString::strerror(int errnum)
{
    switch (errnum) {
    case 1:
