...
void MainWindow::recursiveDisplayTree(QStandardItem *parentItem, Node <QString> *node)
{
    if (node == nullptr)
        return;
...
void MainWindow::on_bnt_cnt_of_list_clicked()
{
    ...
    if (!d1 || !d2) {
        ...
        QMessageBox::information(this, "Ключ наименьшего общего предка                     ",
...
void MainWindow::on_bnt_pre_clicked()
{
    ...
    QMessageBox::information(this, "Результат обхода (ключи)                     ",
                             ans);
}
