...
{
    //ui->textEdit->setText(ui->textEdit->toPlainText() + "Enter number" + "\n");
    QStringList List;
    QDataStream in(&File);
    QString s;
    ...
    case 1:
        ...
        break;
    case 2:
        File.setFileName("/Users/sagot/Documents/Laba6/Task_2/task2/text.txt");
    ...
    case 3:
        ...
        break;
    case 4:
        File.setFileName("/Users/sagot/Documents/Laba6/Task_2/task2/array.txt");
        File.open(QIODevice::ReadOnly);
        s = File.readAll();
        List = s.split("}");
    ...
    case 5:
        ...
        ui->textEdit->setText(ui->textEdit->toPlainText() + "Структура содержит следующие поля:Модель (тип данных: QChar),Водонепроницаемость (тип данных: bool)Цена (тип данных: doube),Час (тип данных: int),Минуты (тип данных: массив int размером 2),Время суток (тип данных: массив QChar размером 2, возможные значения: AM или PM)");
        break;
    case 6:
        File.setFileName("/Users/sagot/Documents/Laba6/Task_2/task2/struct.txt");
        File.open(QIODevice::ReadOnly);
        s = File.readAll();
        List = s.split("\n");
        for (int i = 0; i < List.size(); ++i){
    ...
    case 7:
        ...
        break;
    case 8:
        File.setFileName("/Users/sagot/Documents/Laba6/Task_2/task2/offer.txt");
        File.open(QIODevice::ReadOnly);
        s = File.readAll();
        File.close();
        ui->textEdit->setText(ui->textEdit->toPlainText() + s);
    ...
    case 9:
        ...
        break;
    case 10:
        File.setFileName("/Users/sagot/Documents/Laba6/Task_2/task2/bin.txt");
        File.open(QIODevice::ReadOnly);
        in >> s;
        ui->textEdit->setText(ui->textEdit->toPlainText() + s + "\n");
        File.close();
