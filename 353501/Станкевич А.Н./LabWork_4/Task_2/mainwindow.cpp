...
MainWindow::MainWindow() : ui(new Ui::MainWindow), scene(new QGraphicsScene(this)), timer(new QTimer())
{
    ...
    m_menu->addAction("Interpolation sort");
    ...
    connect(m_menu->actions()[3], &QAction::triggered, this, &MainWindow::InterpolationSortFunction);
...
void MainWindow::InterpolationSortFunction()
{
    ui->pushButton->setText("Interpolation sort");
    sortType = 3;
}
...
void MainWindow::on_pushButton_5_clicked()
{
    if (isSearching)
    {
        ...
        ui->label_3->setText(QString::number(tmp));
            //ui->label_4->setText(QString::number(binpow(tmp, number, mod)));
        }
        else
        {
            ui->label_3->setText("Array hasn't been sorted yet.");
            //ui->label_4->setText("Array hasn't been sorted yet.");
        }
        isSearching = true;
    }
}
